        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/react-component-libraries" className="text-sm text-gray-600 hover:text-gray-900">
                  React Libraries
                </Link>
              </li>
              <li>
                <Link href="/vue-component-libraries" className="text-sm text-gray-600 hover:text-gray-900">
                  Vue Libraries
                </Link>
              </li>
              <li>
                <Link href="/svelte-component-libraries" className="text-sm text-gray-600 hover:text-gray-900">
                  Svelte Libraries
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/showcases" className="text-sm text-gray-600 hover:text-gray-900">
                  Showcases
                </Link>
              </li>
              <li>
